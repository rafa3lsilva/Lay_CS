...
if jogos_do_dia is not None:
    ...
    results_filtrado['Odd_Justa'] = 1 / results_filtrado['Probability'].round(2)
    ...
    if not results_filtrado_ev_positivo.empty:
    ...
    kelly_fracao = 'Kelly Completo'  # Defina a fração de Kelly desejada
    ...
    filtered_df = novo_df[(novo_df['EV+'] == True) & (novo_df['EV_Kelly'] == True)]
