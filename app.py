...
# Dicionrio das Ligas
leagues = ['ALEMANHA - 2. BUNDESLIGA', 'ALEMANHA - 3. LIGA', 'ALEMANHA - BUNDESLIGA', 'ARÁBIA SAUDITA - LIGA PROFISSIONAL SAUDITA',
           'ARGENTINA - COPA DA LIGA PROFISSIONAL', 'ARGENTINA - LIGA PROFISSIONAL', 'ARGENTINA - TORNEO BETANO', 'ARMÊNIA - PREMIER LEAGUE',
           'AUSTRÁLIA - A-LEAGUE','ÁUSTRIA - BUNDESLIGA', 'BÉLGICA - CHALLENGER PRO LEAGUE', 'BÉLGICA - LIGA JUPILER', 'BÉLGICA - LIGA PRO 1B',
           'BOLÍVIA - DIVISIÓN PROFESIONAL', 'BRASIL - BRASILEIRÃO BETANO', 'BRASIL - SÉRIE A', 'BRASIL - SÉRIE B', 'BRASIL - SÉRIE C',
           'BULGÁRIA - PARVA LIGA', 'CHILE - PRIMEIRA DIVISÃO', 'CHINA - SUPERLIGA','COLÔMBIA - PRIMEIRA', 'COREIA DO SUL - LIGA K1', 
           'COREIA DO SUL - LIGA K2', 'CROÁCIA - 1. HNL', 'CROÁCIA - HNL', 'DINAMARCA - SUPERLIGA', 'EGITO - PREMIER LEAGUE','EQUADOR - LIGA PRO',
           'ESCÓCIA - CHAMPIONSHIP', 'ESCÓCIA - LEAGUE ONE (3ª DIVISÃO)', 'ESCÓCIA - PREMIERSHIP', 'ESLOVÁQUIA - FORTUNA LIGA',
           'ESLOVÁQUIA - LIGA NIKE','SLOVÊNIA - PRVA LIGA', 'ESPANHA - LALIGA', 'ESPANHA - LALIGA2', 'ESTÔNIA - MEISTRILIIGA', 'EUA - MLS',
           'FINLÂNDIA - VEIKKAUSLIIGA', 'FRANÇA - LIGUE 1', 'FRANÇA - LIGUE 2','GRÉCIA - SUPERLIGA', 'HUNGRIA - OTP BANK LIGA', 
           'INGLATERRA - CHAMPIONSHIP', 'INGLATERRA - LEAGUE ONE (3ª DIVISÃO)', 'INGLATERRA - LEAGUE TWO (4ª DIVISÃO)', 'INGLATERRA - PREMIER LEAGUE',
           'IRLANDA - DIVISÃO PREMIER', 'IRLANDA DO NORTE - PREMIERSHIP', 'ISLÂNDIA - BESTA-DEILD KARLA', 'ISLÂNDIA - PEPSIDEILD',
           'ISRAEL - LIGAT HA\'AL', 'ITÁLIA - SERIE A', 'ITÁLIA - SERIE B', 'JAPÃO - LIGA J1', 'JAPÃO - LIGA J2', 'MÉXICO - LIGA MX',
           'NORUEGA - ELITESERIEN', 'NORUEGA - OBOS-LIGAEN (2ª DIVISÃO)', 'PAÍS DE GALES - PREMIER LEAGUE', 'PAÍSES BAIXOS - EERSTE DIVISIE',
           'PAÍSES BAIXOS - EREDIVISIE', 'PARAGUAI - PRIMERA DIVISIÓN', 'PERU - LIGA 1', 'POLÔNIA - DIVISÃO 1', 'POLÔNIA - EKSTRAKLASA',
           'PORTUGAL - LIGA PORTUGAL', 'PORTUGAL - LIGA PORTUGAL 2', 'REPÚBLICA TCHECA - CHANCE LIGA','REPÚBLICA TCHECA - FORTUNA LIGA',
           'ROMÊNIA - LIGA 1', 'ROMÊNIA - SUPERLIGA', 'SÉRVIA - SUPERLIGA', 'SUÉCIA - ALLSVENSKAN', 'SUÉCIA - SUPERETTAN', 'SUÍÇA - SUPERLIGA',
           'TURQUIA - SUPER LIG', 'UCRÂNIA - PREMIER LEAGUE', 'URUGUAI - PRIMERA DIVISIÓN', 'VENEZUELA - LIGA FUTVE', 'VENEZUELA - PRIMEIRA DIVISÃO',
           ]
